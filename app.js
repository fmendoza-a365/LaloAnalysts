...
app.use((req, res, next) => {
  ...
  const themePrimary = req.tenant && req.tenant.colorPrimary ? req.tenant.colorPrimary : '#162B3D';
  const themeAccent = req.tenant && req.tenant.colorAccent ? req.tenant.colorAccent : '#2D4A66';
  res.locals.theme = { primary: themePrimary, accent: themeAccent, surface: '#ffffff', textOnPrimary: '#ffffff' };
